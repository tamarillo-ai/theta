...
- **Global scope**: `/Users/marcosmachado/Projects/my-projects/liferay-obj-sdk/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/marcosmachado/Projects/my-projects/liferay-obj-sdk/.codex/notes/`)
...
2. Glob `/Users/marcosmachado/Projects/my-projects/liferay-obj-sdk/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/marcosmachado/Projects/my-projects/liferay-obj-sdk/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/marcosmachado/Projects/my-projects/liferay-obj-sdk/.codex/notes/` — works in any directory
