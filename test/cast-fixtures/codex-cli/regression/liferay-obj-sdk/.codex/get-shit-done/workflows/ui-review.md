...
```bash
UI_AUDITOR_MODEL=$(node "/Users/marcosmachado/Projects/my-projects/liferay-obj-sdk/.codex/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-ui-auditor --raw)
```
...
```markdown
Read /Users/marcosmachado/Projects/my-projects/liferay-obj-sdk/.codex/agents/gsd-ui-auditor.md for instructions.
...
```bash
node "/Users/marcosmachado/Projects/my-projects/liferay-obj-sdk/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
