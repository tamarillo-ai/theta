...
```bash
PHASE_INFO=$(node "D:/code/Project/tablez-demo2-allByAi/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "D:/code/Project/tablez-demo2-allByAi/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "D:/code/Project/tablez-demo2-allByAi/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
