...
```bash
INIT=$(node "D:/code/Project/tablez-demo2-allByAi/.codex/get-shit-done/bin/gsd-tools.cjs" init todos)
...
```bash
slug=$(node "D:/code/Project/tablez-demo2-allByAi/.codex/get-shit-done/bin/gsd-tools.cjs" generate-slug "$title" --raw)
```
...
```bash
node "D:/code/Project/tablez-demo2-allByAi/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture todo - [title]" --files .planning/todos/pending/[filename] .planning/STATE.md
```
