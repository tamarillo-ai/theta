...
- **Global scope**: `/Users/jensonphan/leetcode/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jensonphan/leetcode/.codex/notes/`)
...
2. Glob `/Users/jensonphan/leetcode/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jensonphan/leetcode/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jensonphan/leetcode/.codex/notes/` — works in any directory
