...
- **Global scope**: `/Users/Swayam/Desktop/VITBAIH/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/Swayam/Desktop/VITBAIH/.codex/notes/`)
...
2. Glob `/Users/Swayam/Desktop/VITBAIH/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/Swayam/Desktop/VITBAIH/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/Swayam/Desktop/VITBAIH/.codex/notes/` — works in any directory
