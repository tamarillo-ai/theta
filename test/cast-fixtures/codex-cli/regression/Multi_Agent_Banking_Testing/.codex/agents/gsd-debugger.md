...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/Swayam/Desktop/VITBAIH/.codex
                  → checks /Users/Swayam/Desktop/VITBAIH/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/Swayam/Desktop/VITBAIH/.codex/get-shit-done
                  → writes to /Users/Swayam/Desktop/VITBAIH/.codex/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/Swayam/Desktop/VITBAIH/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/Swayam/Desktop/VITBAIH/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/Swayam/Desktop/VITBAIH/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
