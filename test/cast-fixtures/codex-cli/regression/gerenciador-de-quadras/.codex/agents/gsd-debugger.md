...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.codex
                  → checks C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.codex/get-shit-done
                  → writes to C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.codex/get-shit-done/hooks/
...
```bash
node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Users/gusta/OneDrive/Documentos/gerenciador-de-quadras/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
