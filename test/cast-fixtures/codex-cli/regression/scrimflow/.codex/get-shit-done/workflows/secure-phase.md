...
```
Task(
  prompt="Read C:/Users/simon/Documents/GitHub/scrimflow/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/simon/Documents/GitHub/scrimflow/.codex/get-shit-done/templates/SECURITY.md`
