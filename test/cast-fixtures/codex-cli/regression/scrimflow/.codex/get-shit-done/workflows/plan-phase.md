...
@C:/Users/simon/Documents/GitHub/scrimflow/.codex/get-shit-done/references/revision-loop.md
@C:/Users/simon/Documents/GitHub/scrimflow/.codex/get-shit-done/references/gate-prompts.md
...
Extract from {{GSD_ARGS}}: phase number (integer or decimal like `2.1`), flags (`--research`, `--skip-research`, `--gaps`, `--skip-verify`, `--skip-ui`, `--prd <filepath>`, `--reviews`, `--text`, `--bounce`, `--skip-bounce`, `--chunked`).
...
**If found:**
1. Read template: `C:/Users/simon/Documents/GitHub/scrimflow/.codex/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @C:/Users/simon/Documents/GitHub/scrimflow/.codex/get-shit-done/references/tdd.md to all eligible tasks:
...
if [ "$POST_PLANNING_GAPS" = "true" ]; then
  node "C:/Users/simon/Documents/GitHub/scrimflow/.codex/get-shit-done/bin/gsd-tools.cjs" gap-analysis --phase-dir "${PHASE_DIR}"
fi
```
