...
```bash
INIT=$(node "/Users/wilderherrera/Desktop/convision/.codex/get-shit-done/bin/gsd-tools.cjs" state load 2>/dev/null)
```
...
| Automated browser QA / smoke test whole app, discover UI gaps | `/gsd-qa-explore` | Agent-driven exploration with FINDINGS file |
