...
- **Global scope**: `/Users/wilderherrera/Desktop/convision/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/wilderherrera/Desktop/convision/.codex/notes/`)
...
2. Glob `/Users/wilderherrera/Desktop/convision/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/wilderherrera/Desktop/convision/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/wilderherrera/Desktop/convision/.codex/notes/` — works in any directory
