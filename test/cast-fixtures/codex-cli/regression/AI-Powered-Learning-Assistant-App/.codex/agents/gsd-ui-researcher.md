...
Use template from `/Users/satish/Desktop/AI-Powered Learning Assistant/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/satish/Desktop/AI-Powered Learning Assistant/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/satish/Desktop/AI-Powered Learning Assistant/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
