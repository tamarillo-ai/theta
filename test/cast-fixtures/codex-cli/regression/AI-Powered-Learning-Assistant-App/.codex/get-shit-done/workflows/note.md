...
- **Global scope**: `/Users/satish/Desktop/AI-Powered Learning Assistant/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/satish/Desktop/AI-Powered Learning Assistant/.codex/notes/`)
...
2. Glob `/Users/satish/Desktop/AI-Powered Learning Assistant/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/satish/Desktop/AI-Powered Learning Assistant/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/satish/Desktop/AI-Powered Learning Assistant/.codex/notes/` — works in any directory
