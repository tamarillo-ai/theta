...
```bash
node "/Users/satish/Desktop/AI-Powered Learning Assistant/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: plant seed — {$IDEA}" --files .planning/seeds/SEED-{PADDED}-{slug}.md
```
</step>
