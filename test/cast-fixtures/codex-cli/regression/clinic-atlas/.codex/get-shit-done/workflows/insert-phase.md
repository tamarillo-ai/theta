...
```bash
INIT=$(node "/home/wihan/Projects/clinic-atlas/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/home/wihan/Projects/clinic-atlas/.codex/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
