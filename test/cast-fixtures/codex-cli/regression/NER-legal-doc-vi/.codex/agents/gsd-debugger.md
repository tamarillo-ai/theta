...
<required_reading>
@E:/NER/.codex/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/NER/.codex
                  → checks E:/NER/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/NER/.codex/get-shit-done
                  → writes to E:/NER/.codex/get-shit-done/hooks/
...
@E:/NER/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/NER/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
