...
Knowledge graph is disabled. To activate:
  ...
  node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
