...
Key references:
- @E:/NER/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @E:/NER/.codex/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/NER/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/NER/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/NER/.codex/get-shit-done/USER-PROFILE.md" "E:/NER/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/NER/.codex/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `E:/NER/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @E:/NER/.codex/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to E:/NER/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to E:/NER/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/NER/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated $gsd-dev-preferences at E:/NER/.codex/commands/gsd/dev-preferences.md"

**For AGENTS.md profile section (if selected):**

```bash
node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node E:/NER/.codex/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to E:/NER/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="E:/NER/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    E:/NER/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   E:/NER/.codex/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        E:/NER/.codex/AGENTS.md
```
