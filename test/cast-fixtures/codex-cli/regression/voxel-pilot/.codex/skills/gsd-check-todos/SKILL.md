...
<execution_context>
@D:/Developer/Minecraft_bot/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@D:/Developer/Minecraft_bot/.codex/get-shit-done/workflows/check-todos.md`.
