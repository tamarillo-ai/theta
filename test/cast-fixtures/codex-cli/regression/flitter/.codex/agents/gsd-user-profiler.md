...
<reference>
@/Users/bytedance/.oh-my-coco/studio/flitter/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/bytedance/.oh-my-coco/studio/flitter/.codex/get-shit-done/references/user-profiling.md` to load:
