...
- **Global scope**: `/Users/pavelkushneryk/Documents/vsprojects/go-rag-arxiv/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/pavelkushneryk/Documents/vsprojects/go-rag-arxiv/.codex/notes/`)
...
2. Glob `/Users/pavelkushneryk/Documents/vsprojects/go-rag-arxiv/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/pavelkushneryk/Documents/vsprojects/go-rag-arxiv/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/pavelkushneryk/Documents/vsprojects/go-rag-arxiv/.codex/notes/` — works in any directory
