...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks /home/milgraph/Projects/algo_framework/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/milgraph/Projects/algo_framework/.codex/get-shit-done
                  → writes to /home/milgraph/Projects/algo_framework/.codex/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/milgraph/Projects/algo_framework/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/milgraph/Projects/algo_framework/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/milgraph/Projects/algo_framework/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
